            ...
            <div class="card-deck">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">a person who does a specified type of work or who works in a specified way.</p>
                  </div>
                ...
                <div class="card">
                  <img src="work4.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title">Tree</h5>
                    <p class="card-text">a tree is a perennial plant with an elongated stem, or trunk, supporting branches and leaves in most species.</p>
                  </div>
                  <div class="card-footer">
                    <img style="border-radius: 50%;" src="img_avatar.png" alt="Avatar" height=25>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">work is the energy transferred to or from an object via the application of force along a displacement. In its simplest form.</p>
                  </div>
                  <div class="card-footer">
                    <img style="border-radius: 50%;" src="img_avatar.png" alt="Avatar" height=25>
