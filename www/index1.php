      ...
      <div class="card-deck">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              a person who does a specified type of work or who works in a
              specified way.
            </p>
          </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              work is the energy transferred to or from an object via the
              application of force along a displacement. In its simplest form.
            </p>
          </div>
          <div class="card-footer">
            <img
